...
{
    public class MultiThreadObservableImmutableList<T> : MultiThreadObservableCollection, IList, ICollection, IEnumerable, IList<T>, IImmutableList<T>, ICollection<T>, IEnumerable<T>, IReadOnlyList<T>, IReadOnlyCollection<T>, INotifyCollectionChanged, INotifyPropertyChanged
    {
        #region Private
        ...
        public MultiThreadObservableImmutableList()
            : this(new T[0], LockTypeEnum.SpinWait)
        {
        }

        public MultiThreadObservableImmutableList(IEnumerable<T> items)
            : this(items, LockTypeEnum.SpinWait)
        {
        }

        public MultiThreadObservableImmutableList(LockTypeEnum lockType)
            : this(new T[0], lockType)
        {
        }

        public MultiThreadObservableImmutableList(IEnumerable<T> items, LockTypeEnum lockType)
            : base(lockType)
        {
