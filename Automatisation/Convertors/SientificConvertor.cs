...
{
    public static class SientificConvertor
    {
        /// <summary>
        ...
        public static string FromSIStringToPrefix(this string value)
        {
            string stringValue = value;
            string[] stringValueParts = stringValue.Split("E".ToCharArray());
            double mantissa = Convert.ToDouble(stringValueParts[0], CultureInfo.InvariantCulture);
        ...
        public static string FromPrefixToSIString(this string prefixedValue)
        {
            string scientificNotationValue = prefixedValue.ToUpper();
